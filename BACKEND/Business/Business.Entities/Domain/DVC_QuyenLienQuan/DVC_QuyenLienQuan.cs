...
{
    public class DVC_QLQ_QuyenLienQuanMap : PagesModel
    {
        ...
        public List<DVC_QLQ_NguoiBieuDienAdd> ListNguoiBieuDien { get; set; }
        public List<DVC_QLQ_ChuSoHuuAdd> ListChuSoHuu { get; set; }
    }
    public class DVC_QLQ_QuyenLienQuanParam : PagesParamModel
    {
        public string TuKhoa { get; set; }
        public string SoGCN { get; set; }
        public string NgayCapTu { get; set; }
        public string NgayCapDen { get; set; }
        public string TenNguoiBieuDien { get; set; }
        public string TenChuSoHuu { get; set; }
        public string CreatedUser { get; set; }
        public int VungMienID { get; set; }
        public int TrangThaiID { get; set; }
    }
    public class DVC_QLQ_QuyenLienQuanAdd
    {
        public long QuyenLienQuanID { get; set; }
        public string STT { get; set; }
        public string SoGCN { get; set; }
        ...
        public List<DVC_QLQ_LichSuMap> ListLichSu { get; set; }
        public List<DVC_QLQ_NguoiBieuDienAdd> ListNguoiBieuDien { get; set; }
        public List<DVC_QLQ_ChuSoHuuAdd> ListChuSoHuu { get; set; }
        public List<DVC_QLQ_DinhKemAdd> ListDinhKem { get; set; }
    }
    public class DVC_QLQ_QuyenLienQuanChange
    {
        public long QuyenLienQuanID { get; set; }
        public string STT { get; set; }
        public string SoGCN { get; set; }
    ...
    public class DVC_QLQ_ChuSoHuuAdd
    {
    ...
    public class DVC_QLQ_NguoiBieuDienAdd
    {
    ...
    public class DVC_QLQ_DinhKemAdd
    {
    ...
    public class DVC_QLQ_GiayChungNhanMap : PagesModel
    {
        public string STT { get; set; }
        public long QuyenLienQuanID { get; set; }
        public string SoGCN { get; set; }
    ...
    public class DVC_QLQ_GiayChungNhanParam : PagesParamModel
    {
        public string TuKhoa { get; set; }
    }
    public class DVC_QLQ_QuyenLienQuan_CapSo
    {
