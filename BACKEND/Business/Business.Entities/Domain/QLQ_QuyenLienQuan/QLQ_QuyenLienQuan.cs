...
{
    public class QLQ_QuyenLienQuanMap : PagesModel
    {
        ...
        public List<QLQ_NguoiBieuDienAdd> ListNguoiBieuDien { get; set; }
        public List<QLQ_ChuSoHuuAdd> ListChuSoHuu { get; set; }
    }
    public class QLQ_QuyenLienQuanParam : PagesParamModel
    {
    ...
    public class QLQ_QuyenLienQuanAdd
    {
        public long QuyenLienQuanID { get; set; }
        public string STT { get; set; }
        public string SoGCN { get; set; }
        ...
        public List<QLQ_LichSuMap> ListLichSu { get; set; }

    }
    public class QLQ_QuyenLienQuanChange
    {
        public long QuyenLienQuanID { get; set; }
        public string STT { get; set; }
        public string SoGCN { get; set; }
    ...
    public class QLQ_NguoiBieuDienAdd
    {
    ...
    public class QLQ_GiayChungNhanMap : PagesModel
    {
        public string STT { get; set; }
        public long QuyenLienQuanID { get; set; }
        public string SoGCN { get; set; }
    ...
    public class QLQ_GiayChungNhanParam : PagesParamModel
    {
        public string TuKhoa { get; set; }
    }
    public class QLQ_SoThuTuMap : PagesModel
    {
        public string STT { get; set; }
        public long QuyenLienQuanID { get; set; }
        public string TenTacPham { get; set; }
    ...
    public class QLQ_SoThuTuParam : PagesParamModel
    {
        public string TuKhoa { get; set; }
    }
    public class QLQ_QuyenLienQuan_CapSo
    {
