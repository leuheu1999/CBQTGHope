...
{
    public class DVC_QTG_QuyenTacGiaMap : PagesModel
    {
        ...
        public List<DVC_QTG_TacGiaAdd> ListTacGia { get; set; }
        public List<DVC_QTG_ChuSoHuuAdd> ListChuSoHuu { get; set; }
    }
    public class DVC_QTG_QuyenTacGiaParam : PagesParamModel
    {
    ...
    public class DVC_QTG_QuyenTacGiaAdd
    {
        public long QuyenTacGiaID { get; set; }
        public string STT { get; set; }
        public string SoGCN { get; set; }
        ...
        public List<DVC_QTG_LichSuMap> ListLichSu { get; set; }
        public List<DVC_QTG_TacGiaAdd> ListTacGia { get; set; }
        public List<DVC_QTG_ChuSoHuuAdd> ListChuSoHuu { get; set; }
        public List<DVC_QTG_DinhKemAdd> ListDinhKem { get; set; }
    }
    public class DVC_QTG_QuyenTacGiaChange
    {
        public long QuyenTacGiaID { get; set; }
        public string STT { get; set; }
        public string SoGCN { get; set; }
    ...
    public class DVC_QTG_ChuSoHuuAdd
    {
    ...
    public class DVC_QTG_TacGiaAdd
    {
    ...
    public class DVC_QTG_DinhKemAdd
    {
    ...
    public class DVC_QTG_GiayChungNhanMap : PagesModel
    {
        public string STT { get; set; }
        public long QuyenTacGiaID { get; set; }
        public string SoGCN { get; set; }
    ...
    public class DVC_QTG_GiayChungNhanParam : PagesParamModel
    {
        public string TuKhoa { get; set; }
    }
    public class DVC_QTG_QuyenTacGia_CapSo
    {
