var DMQuyenThemMoi = function (options) {
    for (var property in options) {
        this[property] = options[property];
    }
    return this.Initialize(options);
};
DMQuyenThemMoi.prototype = {
    ...
    RegisterEvent: function () {
        ...
        $("#btnLuuDV").unbind("click").click(function () {
            ...
            if (/<[a-z][\s\S]*>/i.test(ma) || (/<[/s/S][a-z][\s\S]*>/i.test(ma))) {
                $(".thongbaoma").html("Ma " + that.Message.MaHtml);
                $(".thongbaoma").show();
                $("input[name='Ma']").focus();
                return false;
            }
            ...
            Common.Ajax({
                ...
                if (!Common.Empty(result)) {
                    if (result.checkMa == true && result.status == false) {
                        ...
                        Common.DMQuyenThemMoi.HideDialog();
    ...
    ShowDialog: function () {
        ...
        Common.DMQuyenThemMoi.RegisterEvent();
    },
    HideDialog: function () {
        $("#dialogAddDanhMuc").modal("hide");
    }
};
// create DMQuyenThemMoi Object
var DMQuyenThemMoi = DMQuyenThemMoi;
DMQuyenThemMoi.constructor = DMQuyenThemMoi;
