var DVC_QuyenTacGia_ChiTiet = function (options) {
    for (var property in options) {
        this[property] = options[property];
    }
    return this.Initialize(options);
};
DVC_QuyenTacGia_ChiTiet.prototype = {
    ...
    RegisterEvent: function () {
                ...
                Items: {
                    Cancel: {
                        ...
                        OnClick: function (target) {
                            ...
                            Common.Ajax({
                                type: "POST",
                                url: Common.DVC_QuyenTacGia_ChiTiet.Url.DeleteQuyenTacGia,
                                async: false,
                                cache: false,
                                data: {
                                    id: id
                                ...
                                if (data) {
                                    ...
                                    Common.HideAlert();
                                    window.location = Common.DVC_QuyenTacGia_ChiTiet.Url.Index;
                                } else {
                                    $.notify({
                                        // options
        ...
        $(".btnExportFile").unbind("click").click(function () {
            ...
            Common.Ajax({
                type: "POST",
                url: Common.DVC_QuyenTacGia_ChiTiet.Url.ExportWordPdf,
                async: false,
                cache: false,
...
var DVC_QuyenTacGia_ChiTiet = DVC_QuyenTacGia_ChiTiet;
DVC_QuyenTacGia_ChiTiet.constructor = DVC_QuyenTacGia_ChiTiet;