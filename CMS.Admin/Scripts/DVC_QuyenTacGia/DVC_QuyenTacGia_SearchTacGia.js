var DVC_QuyenTacGia_SearchTacGia = function (options) {
    for (var property in options) {
        this[property] = options[property];
    }
    return this.Initialize(options);
}
DVC_QuyenTacGia_SearchTacGia.prototype = {
    ...
    RegisterEvent: function () {
        ...
        $("#btnSearchTacGia").unbind("click").click(function () {
            Common.DVC_QuyenTacGia_SearchTacGia.SubmitForm();
            return false;
        });
            ...
            if ($('input[name="chkInputCheckedTG[]"]:checked').length > 0) {
                $('input[name="chkInputCheckedTG[]"]').each(function () {
                    if ($(this).prop("checked")) {
                        var check = Common.DVC_QuyenTacGia_SearchTacGia.ListTacGia.find(x => x.TacGiaID === $(this).closest("tr").data("id"));
                        if (typeof check != 'undefined') {
                            ...
                            Common.DVC_QuyenTacGia_SearchTacGia.ListTacGia.push({
                ...
                Common.DVC_QuyenTacGia_SearchTacGia.LoadTableTacGia();
                Common.DVC_QuyenTacGia_SearchTacGia.HideDialog();
                return false;
            }
        });
        ...
        $(".btn-update-tacgia").unbind("click").click(function () {
            ...
            Common.Ajax({
                url: Common.DVC_QuyenTacGia_SearchTacGia.Url.UpdateTacGia,
                type: "POST",
                ...
                if (!Common.Empty(result)) {
                    ...
                    Common.DVC_QuyenTacGia_SearchTacGia.RegisterEvent();
                }
            }
            );
            return false;
        ...
        $("#btnSaveTacGia").unbind("click").click(function () {
            ...
            if ($("#form-update-tacgia").find(".field-validation-error").length == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: Common.DVC_QuyenTacGia_SearchTacGia.Url.SaveTacGia,
                    data: formdata,
                    datatype: "json",
    ...
    SubmitForm: function () {
        ...
        Common.Ajax({
            type: 'POST',
            url: Common.DVC_QuyenTacGia_SearchTacGia.Url.SearchTacGia,
            data: formdata,
            contentType: false, // Not to set any content header
            processData: false, // Not to process data
            dataType: 'html',
            ...
            Common.DVC_QuyenTacGia_SearchTacGia.ShowDialog();
        });
        return false;
    },
    Paging: function (page) {
        Common.DVC_QuyenTacGia_SearchTacGia.SetPage(page);
        Common.DVC_QuyenTacGia_SearchTacGia.SubmitForm();
        return false;
    },
    ...
    ChangePageSize: function (e) {
        Common.DVC_QuyenTacGia_SearchTacGia.SetPageSize($(e).val());
        Common.DVC_QuyenTacGia_SearchTacGia.SubmitForm();
        return false;
    },
    ShowDialog: function () {
    ...
    LoadTableTacGia: function () {
        var html = '';
        if (Common.DVC_QuyenTacGia_SearchTacGia.ListTacGia != null && Common.DVC_QuyenTacGia_SearchTacGia.ListTacGia.length > 0) {
            for (i = 0; i < Common.DVC_QuyenTacGia_SearchTacGia.ListTacGia.length; i++) {
                var tacGia = Common.DVC_QuyenTacGia_SearchTacGia.ListTacGia[i];
                html += '<tr>';
                ...
                html += '<button title="Xóa tác giả" data-id="' + tacGia.TacGiaID + '" class="btn btn-danger btn-sm" type="button" onclick="Common.DVC_QuyenTacGia_SearchTacGia.RemovedTacGia(' + i + ')"><i class="far fa-trash-alt"></i></button>';
                html += '</td>';
                html += '</tr>';
            }
        }
    ...
    RemovedTacGia: function (id) {
        Common.DVC_QuyenTacGia_SearchTacGia.ListTacGia.splice(id, 1)
        Common.DVC_QuyenTacGia_SearchTacGia.LoadTableTacGia();
        return false;
    },
};

var DVC_QuyenTacGia_SearchTacGia = DVC_QuyenTacGia_SearchTacGia;
DVC_QuyenTacGia_SearchTacGia.constructor = DVC_QuyenTacGia_SearchTacGia;
