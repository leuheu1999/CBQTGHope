var DVC_QuyenTacGia_SearchChuSoHuu = function (options) {
    for (var property in options) {
        this[property] = options[property];
    }
    return this.Initialize(options);
}
DVC_QuyenTacGia_SearchChuSoHuu.prototype = {
    ...
    RegisterEvent: function () {
        ...
        $("#btnSearchChuSoHuu").unbind("click").click(function () {
            Common.DVC_QuyenTacGia_SearchChuSoHuu.SubmitForm();
            return false;
        });
            ...
            if ($('input[name="chkInputCheckedCSH[]"]:checked').length > 0) {
                $('input[name="chkInputCheckedCSH[]"]').each(function () {
                    if ($(this).prop("checked")) {
                        var check = Common.DVC_QuyenTacGia_SearchChuSoHuu.ListChuSoHuu.find(x => x.ChuSoHuuID === $(this).closest("tr").data("id"));
                ...
                Common.DVC_QuyenTacGia_SearchChuSoHuu.LoadTableChuSoHuu();
                Common.DVC_QuyenTacGia_SearchChuSoHuu.HideDialog();
                return false;
            }
        });
        ...
        $(".btn-update-chusohuu").unbind("click").click(function () {
            ...
            Common.Ajax({
                url: Common.DVC_QuyenTacGia_SearchChuSoHuu.Url.UpdateChuSoHuu,
                type: "POST",
        ...
        $("#btnSaveChuSoHuu").unbind("click").click(function () {
            ...
            if ($("#form-update-chusohuu").find(".field-validation-error").length == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: Common.DVC_QuyenTacGia_SearchChuSoHuu.Url.SaveChuSoHuu,
                    data: formdata,
                    datatype: "json",
    ...
    SubmitForm: function () {
        ...
        Common.Ajax({
            type: 'POST',
            url: Common.DVC_QuyenTacGia_SearchChuSoHuu.Url.SearchChuSoHuu,
            data: formdata,
            contentType: false, // Not to set any content header
            processData: false, // Not to process data
            dataType: 'html',
            ...
            Common.DVC_QuyenTacGia_SearchChuSoHuu.ShowDialog();
        });
        return false;
    },
    Paging: function (page) {
        Common.DVC_QuyenTacGia_SearchChuSoHuu.SetPage(page);
        Common.DVC_QuyenTacGia_SearchChuSoHuu.SubmitForm();
        return false;
    },
    ...
    ChangePageSize: function (e) {
        Common.DVC_QuyenTacGia_SearchChuSoHuu.SetPageSize($(e).val());
        Common.DVC_QuyenTacGia_SearchChuSoHuu.SubmitForm();
        return false;
    },
    ShowDialog: function () {
    ...
    LoadTableChuSoHuu: function () {
        var html = '';
        if (Common.DVC_QuyenTacGia_SearchChuSoHuu.ListChuSoHuu != null && Common.DVC_QuyenTacGia_SearchChuSoHuu.ListChuSoHuu.length > 0) {
            for (i = 0; i < Common.DVC_QuyenTacGia_SearchChuSoHuu.ListChuSoHuu.length; i++) {
                var chuSoHuu = Common.DVC_QuyenTacGia_SearchChuSoHuu.ListChuSoHuu[i];
                html += '<tr>';
                ...
                html += '<button title="Xóa chủ sở hữu" data-id="' + chuSoHuu.ChuSoHuuID + '" class="btn btn-danger btn-sm" type="button" onclick="Common.DVC_QuyenTacGia_SearchChuSoHuu.RemovedChuSoHuu(' + i + ')"><i class="far fa-trash-alt"></i></button>';
                html += '</td>';
                html += '</tr>';
            }
        }
    ...
    RemovedChuSoHuu: function (id) {
        Common.DVC_QuyenTacGia_SearchChuSoHuu.ListChuSoHuu.splice(id, 1)
        Common.DVC_QuyenTacGia_SearchChuSoHuu.LoadTableChuSoHuu();
        return false;
    },
};

var DVC_QuyenTacGia_SearchChuSoHuu = DVC_QuyenTacGia_SearchChuSoHuu;
DVC_QuyenTacGia_SearchChuSoHuu.constructor = DVC_QuyenTacGia_SearchChuSoHuu;
