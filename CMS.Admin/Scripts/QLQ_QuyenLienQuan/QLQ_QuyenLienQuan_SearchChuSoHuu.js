var QLQ_QuyenLienQuan_SearchChuSoHuu = function (options) {
    for (var property in options) {
        this[property] = options[property];
    }
    return this.Initialize(options);
}
QLQ_QuyenLienQuan_SearchChuSoHuu.prototype = {
    ...
    RegisterEvent: function () {
            ...
            if ($('input[name="chkInputCheckedCSH[]"]:checked').length > 0) {
                $('input[name="chkInputCheckedCSH[]"]').each(function () {
                    if ($(this).prop("checked")) {
                        var check = Common.QLQ_QuyenLienQuan_SearchChuSoHuu.ListChuSoHuu.find(x => x.ChuSoHuuID === $(this).closest("tr").data("id"));
                        if (typeof check != 'undefined') {
                            ...
                            Common.QLQ_QuyenLienQuan_SearchChuSoHuu.ListChuSoHuu.push({
                ...
                Common.QLQ_QuyenLienQuan_SearchChuSoHuu.LoadTableChuSoHuu();
                Common.QLQ_QuyenLienQuan_SearchChuSoHuu.HideDialog();
                return false;
            }
        });
        ...
        $(".btn-update-chusohuu").unbind("click").click(function () {
            ...
            Common.Ajax({
                url: Common.QLQ_QuyenLienQuan_SearchChuSoHuu.Url.UpdateChuSoHuu,
                type: "POST",
                ...
                if (!Common.Empty(result)) {
                    ...
                    Common.QLQ_QuyenLienQuan_SearchChuSoHuu.RegisterEvent();
                }
            }
            );
            return false;
        ...
        $("#btnSaveChuSoHuu").unbind("click").click(function () {
            ...
            if ($("#form-update-chusohuu").find(".field-validation-error").length == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: Common.QLQ_QuyenLienQuan_SearchChuSoHuu.Url.SaveChuSoHuu,
                    data: formdata,
                    datatype: "json",
    ...
    SubmitForm: function () {
        ...
        Common.Ajax({
            type: 'POST',
            url: Common.QLQ_QuyenLienQuan_SearchChuSoHuu.Url.SearchChuSoHuu,
            data: formdata,
            contentType: false, // Not to set any content header
            processData: false, // Not to process data
            dataType: 'html',
            ...
            Common.QLQ_QuyenLienQuan_SearchChuSoHuu.ShowDialog();
        });
        return false;
    },
    Paging: function (page) {
        Common.QLQ_QuyenLienQuan_SearchChuSoHuu.SetPage(page);
        Common.QLQ_QuyenLienQuan_SearchChuSoHuu.SubmitForm();
        return false;
    },
    ...
    ChangePageSize: function (e) {
        Common.QLQ_QuyenLienQuan_SearchChuSoHuu.SetPageSize($(e).val());
        Common.QLQ_QuyenLienQuan_SearchChuSoHuu.SubmitForm();
        return false;
    },
    ShowDialog: function () {
    ...
    LoadTableChuSoHuu: function () {
        var html = '';
        if (Common.QLQ_QuyenLienQuan_SearchChuSoHuu.ListChuSoHuu != null && Common.QLQ_QuyenLienQuan_SearchChuSoHuu.ListChuSoHuu.length > 0) {
            for (i = 0; i < Common.QLQ_QuyenLienQuan_SearchChuSoHuu.ListChuSoHuu.length; i++) {
                var chuSoHuu = Common.QLQ_QuyenLienQuan_SearchChuSoHuu.ListChuSoHuu[i];
                html += '<tr>';
                ...
                html += '<button title="Xóa chủ sở hữu" data-id="' + chuSoHuu.ChuSoHuuID + '" class="btn btn-danger btn-sm" type="button" onclick="Common.QLQ_QuyenLienQuan_SearchChuSoHuu.RemovedChuSoHuu(' + i + ')"><i class="far fa-trash-alt"></i></button>';
                html += '</td>';
                html += '</tr>';
            }
        }
    ...
    RemovedChuSoHuu: function (id) {
        Common.QLQ_QuyenLienQuan_SearchChuSoHuu.ListChuSoHuu.splice(id, 1)
        Common.QLQ_QuyenLienQuan_SearchChuSoHuu.LoadTableChuSoHuu();
        return false;
    },
};

var QLQ_QuyenLienQuan_SearchChuSoHuu = QLQ_QuyenLienQuan_SearchChuSoHuu;
QLQ_QuyenLienQuan_SearchChuSoHuu.constructor = QLQ_QuyenLienQuan_SearchChuSoHuu;
