var QLQ_ThuHoi_ThemMoi = function (options) {
    for (var property in options) {
        this[property] = options[property];
    }
    return this.Initialize(options);
};
QLQ_ThuHoi_ThemMoi.prototype = {
    ...
    RegisterEvent: function () {
        ...
        $(".btnSubmitNewCapNhat").unbind('click').click(function (e) {
            ...
            if ($("#form-update-tt-thuhoi").find(".field-validation-error").length == 0) {
                var _model = {
                    QuyenLienQuanID: $("#form-update-tt-tacpham").find("input[name='QuyenLienQuanID']").val() || 0,
                    ...
                    SoLanThuHoi: $("#form-update-tt-tacpham").find("input[name='QuyenLienQuan.SoLanThuHoi']").val() || 0,
                ...
                $.ajax({
                    type: 'POST',
                    url: Common.QLQ_ThuHoi_ThemMoi.Url.SaveThuHoi,
                    data: formdata,
                    datatype: "json",
        ...
        $(".btn-view-file").unbind("click").click(function () {
            var url = Common.QLQ_ThuHoi_ThemMoi.Url.ViewFile
                ...
                Items: {
                    ...
                    Cancel: {
                        ...
                        OnClick: function (target) {
                            ...
                            if (key == 'capso')
                                window.location = Common.QLQ_ThuHoi_ThemMoi.Url.IndexCapSo;
                            else if (id > 0)
                                window.location = Common.QLQ_ThuHoi_ThemMoi.Url.IndexHoSo;
                            else
                                window.location = Common.QLQ_ThuHoi_ThemMoi.Url.Index;
                        },
                        Value: "Đồng ý"
                    }
                }
...
var QLQ_ThuHoi_ThemMoi = QLQ_ThuHoi_ThemMoi;
QLQ_ThuHoi_ThemMoi.constructor = QLQ_ThuHoi_ThemMoi;