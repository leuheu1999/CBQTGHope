...
var DM_NguoiKy = function (options) {
...
DM_NguoiKy.prototype = {
    ...
    RegisterEvent: function () {
        ...
        $("#btnAddForm").unbind("click").click(function () {
            ...
            $("#dialogAddNguoiKy .modal-title").text("Thêm mới danh mục người ký");
            Common.DM_NguoiKyThemMoi.ShowDialog();
            return false;
        });
        ...
        $(".btnUpdate").unbind("click").click(function () {
            ...
            Common.Ajax({
                ...
                async: false,
                cache: false,
                url: Common.DM_NguoiKy.Url.Update,
                dataType: 'html',
                data: { id: id }
            }, function (result) {
                if (!Common.Empty(result)) {
                    $("#form-update").html(result);
                    $("#dialogAddNguoiKy .modal-title").text("Cập nhật danh mục người ký");
                    Common.DM_NguoiKyThemMoi.ShowDialog();
                }
            });
            return false;
                ...
                Cancel: {
                    ...
                    OnClick: function (target) {
                        Common.Ajax({
                            ...
                            async: false,
                            cache: false,
                            url: Common.DM_NguoiKy.Url.Delete,
                            dataType: 'JSON',
                            data: { id: id }
                        }, function (result) {
                            if (!Common.Empty(result)) {
    ...
    Paging: function (page) {
        Common.DM_NguoiKy.SetPage(page);
        Common.DM_NguoiKy.SubmitForm();
        return false;
    },
    ...
    ChangePageSize: function (e) {
        Common.DM_NguoiKy.SetPageSize($(e).val());
        Common.DM_NguoiKy.SubmitForm();
        return false;
    },
...
// create DM_NguoiKy Object
var DM_NguoiKy = DM_NguoiKy;
DM_NguoiKy.constructor = DM_NguoiKy;
