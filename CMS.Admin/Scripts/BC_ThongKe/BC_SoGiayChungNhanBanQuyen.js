var BC_SoGiayChungNhanBanQuyen = function (options) {
    for (var property in options) {
        this[property] = options[property];
    }
    return this.Initialize(options);
}
BC_SoGiayChungNhanBanQuyen.prototype = {
    ...
    RegisterEvent: function () {
        ...
        $("a[data-action='reload']").unbind("click").click(function () {
            ...
            Common.BC_SoGiayChungNhanBanQuyen.SubmitForm();
        });

        $("#btnTimKiem").unbind("click").click(function () {
            Common.BC_SoGiayChungNhanBanQuyen.SetPage(1);
            Common.BC_SoGiayChungNhanBanQuyen.SubmitForm();
            return false;
        });
        ...
        $("#QuyenID").unbind("change").change(function () {
            ...
            Common.BC_SoGiayChungNhanBanQuyen.AjaxCBOLoaiHinh(val);
            return false;
        });
        ...
        $("#KyBaoCao").unbind("select2:select").on("select2:select", (e) => {
            ...
            Common.BC_SoGiayChungNhanBanQuyen.RefeshSelect2("#Nam, #Quy, #Thang");
        });
        $("#btn-word").unbind("click").click(function () {
            ...
            Common.Ajax({
                type: "POST",
                url: Common.BC_SoGiayChungNhanBanQuyen.Url.ExportWordPdf,
                async: false,
                cache: false,
                data: { Param: _model, Key: 'ExportBC_SoGiayChungNhanBanQuyenList_Word' }
            }, function (result) {
                if (result) {
        ...
        $("#btn-excel").unbind("click").click(function () {
            ...
            Common.Ajax({
                type: "POST",
                url: Common.BC_SoGiayChungNhanBanQuyen.Url.ExportExcel,
                async: false,
                cache: false,
                data: { Param: _model, Key: 'ExportBC_SoGiayChungNhanBanQuyenList_Excel' }
            }, function (result) {
                if (result) {
                    let a = document.createElement('a')
                    a.href = 'data:application/octet-stream;base64,' + result.data;
        ...
        $("#btn-pdf").unbind("click").click(function () {
            ...
            Common.Ajax({
                ...
                async: false,
                cache: false,
                data: { Param: _model, Key: 'ExportBC_SoGiayChungNhanBanQuyenList_Pdf' }
            }, function (result) {
                if (result) {
                    let a = document.createElement('a')
                    a.href = 'data:application/octet-stream;base64,' + result.data;
    ...
    Paging: function (page) {
        Common.BC_SoGiayChungNhanBanQuyen.SetPage(page);
        Common.BC_SoGiayChungNhanBanQuyen.SubmitForm();
        return false;
    },
    ...
    ChangePageSize: function (e) {
        Common.BC_SoGiayChungNhanBanQuyen.SetPageSize($(e).val());
        Common.BC_SoGiayChungNhanBanQuyen.SubmitForm();
        return false;
    },
    ...
    Success: function (data) {
        ...
        Common.BC_SoGiayChungNhanBanQuyen.RegisterEvent();
    },
    AjaxCBOLoaiHinh: function (id) {
        Common.Ajax({
            url: Common.BC_SoGiayChungNhanBanQuyen.Url.CBOLoaiHinhById,
            type: "POST",
            ...
            if (!Common.Empty(result)) {
                var html = Common.BC_SoGiayChungNhanBanQuyen.TemplateHtmlCBO("Loại hình", "LoaiHinhID", "LoaiHinhID", result.data);
...
// create BC_SoGiayChungNhanBanQuyen Object
var BC_SoGiayChungNhanBanQuyen = BC_SoGiayChungNhanBanQuyen;
BC_SoGiayChungNhanBanQuyen.constructor = BC_SoGiayChungNhanBanQuyen;
