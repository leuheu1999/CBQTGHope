var DVC_QuyenLienQuan_SearchNguoiBieuDien = function (options) {
    for (var property in options) {
        this[property] = options[property];
    }
    return this.Initialize(options);
}
DVC_QuyenLienQuan_SearchNguoiBieuDien.prototype = {
    ...
    RegisterEvent: function () {
            ...
            if ($('input[name="chkInputCheckedNBD[]"]:checked').length > 0) {
                $('input[name="chkInputCheckedNBD[]"]').each(function () {
                    if ($(this).prop("checked")) {
                        var check = Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.ListNguoiBieuDien.find(x => x.NguoiBieuDienID === $(this).closest("tr").data("id"));
                        if (typeof check != 'undefined') {
                            ...
                            Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.ListNguoiBieuDien.push({
                ...
                Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.LoadTableNguoiBieuDien();
                Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.HideDialog();
                return false;
            }
        });
        ...
        $(".btn-update-nguoibieudien").unbind("click").click(function () {
            ...
            Common.Ajax({
                url: Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.Url.UpdateNguoiBieuDien,
                type: "POST",
                ...
                if (!Common.Empty(result)) {
                    ...
                    Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.RegisterEvent();
                }
            }
            );
            return false;
        ...
        $("#btnSaveNguoiBieuDien").unbind("click").click(function () {
            ...
            if ($("#form-update-nguoibieudien").find(".field-validation-error").length == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.Url.SaveNguoiBieuDien,
                    data: formdata,
                    datatype: "json",
    ...
    SubmitForm: function () {
        ...
        Common.Ajax({
            type: 'POST',
            url: Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.Url.SearchNguoiBieuDien,
            data: formdata,
            contentType: false, // Not to set any content header
            processData: false, // Not to process data
            dataType: 'html',
            ...
            Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.ShowDialog();
        });
        return false;
    },
    Paging: function (page) {
        Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.SetPage(page);
        Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.SubmitForm();
        return false;
    },
    ...
    ChangePageSize: function (e) {
        Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.SetPageSize($(e).val());
        Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.SubmitForm();
        return false;
    },
    ShowDialog: function () {
    ...
    LoadTableNguoiBieuDien: function () {
        var html = '';
        if (Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.ListNguoiBieuDien != null && Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.ListNguoiBieuDien.length > 0) {
            for (i = 0; i < Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.ListNguoiBieuDien.length; i++) {
                var nguoiBieuDien = Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.ListNguoiBieuDien[i];
                html += '<tr>';
                ...
                html += '<button title="Xóa người biểu diễn" data-id="' + nguoiBieuDien.NguoiBieuDienID + '" class="btn btn-danger btn-sm" type="button" onclick="Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.RemovedNguoiBieuDien(' + i + ')"><i class="far fa-trash-alt"></i></button>';
                html += '</td>';
                html += '</tr>';
            }
        }
    ...
    RemovedNguoiBieuDien: function (id) {
        Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.ListNguoiBieuDien.splice(id, 1)
        Common.DVC_QuyenLienQuan_SearchNguoiBieuDien.LoadTableNguoiBieuDien();
        return false;
    },
};

var DVC_QuyenLienQuan_SearchNguoiBieuDien = DVC_QuyenLienQuan_SearchNguoiBieuDien;
DVC_QuyenLienQuan_SearchNguoiBieuDien.constructor = DVC_QuyenLienQuan_SearchNguoiBieuDien;
