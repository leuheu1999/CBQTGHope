var DVC_QuyenLienQuan_SearchCongDan = function (options) {
    for (var property in options) {
        this[property] = options[property];
    }
    return this.Initialize(options);
}
DVC_QuyenLienQuan_SearchCongDan.prototype = {
    ...
    RegisterEvent: function () {
        ...
        $("#btnAddCongDan").unbind("click").click(function (event) {
            ...
            if ($('input[name="chkInputCheckedCSH[]"]:checked').length > 0) {
                $('input[name="chkInputCheckedCSH[]"]').each(function () {
                    if ($(this).prop("checked")) {
                        var check = Common.DVC_QuyenLienQuan_SearchCongDan.ListChuSoHuu.find(x => x.ChuSoHuuID === $(this).closest("tr").data("id"));
            ...
            if ($('input[name="chkInputCheckedNBD[]"]:checked').length > 0) {
                $('input[name="chkInputCheckedNBD[]"]').each(function () {
                    if ($(this).prop("checked")) {
                        var check = Common.DVC_QuyenLienQuan_SearchCongDan.ListNguoiBieuDien.find(x => x.NguoiBieuDienID === $(this).closest("tr").data("id"));
                        //if (typeof check != 'undefined') {
                        //    $.notify({
                        //        // options
            ...
            Common.DVC_QuyenLienQuan_SearchCongDan.LoadTableChuSoHuu();
            Common.DVC_QuyenLienQuan_SearchCongDan.LoadTableNguoiBieuDien();
            Common.DVC_QuyenLienQuan_SearchCongDan.HideDialog();
            return false;
        });
        ...
        $(".btn-update-congdan").unbind("click").click(function () {
            ...
            Common.Ajax({
                url: Common.DVC_QuyenLienQuan_SearchCongDan.Url.UpdateCongDan,
                type: "POST",
        ...
        $("#btnSaveCongDan").unbind("click").click(function () {
            ...
            if ($("#form-update-congdan").find(".field-validation-error").length == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: Common.DVC_QuyenLienQuan_SearchCongDan.Url.SaveCongDan,
                    data: formdata,
                    datatype: "json",
    ...
    SubmitForm: function () {
        ...
        Common.Ajax({
            type: 'POST',
            url: Common.DVC_QuyenLienQuan_SearchCongDan.Url.SearchCongDan,
            data: formdata,
            contentType: false, // Not to set any content header
            processData: false, // Not to process data
            dataType: 'html',
            ...
            Common.DVC_QuyenLienQuan_SearchCongDan.ShowDialog();
            $('input[name="chkInputCheckedCSH[]"]').each(function () {
                var check = Common.DVC_QuyenLienQuan_SearchCongDan.ListChuSoHuu.find(x => x.ChuSoHuuID === $(this).closest("tr").data("id"));
                if (typeof check != 'undefined') {
    ...
    Paging: function (page) {
        Common.DVC_QuyenLienQuan_SearchCongDan.SetPage(page);
        Common.DVC_QuyenLienQuan_SearchCongDan.SubmitForm();
        return false;
    },
    ...
    ChangePageSize: function (e) {
        Common.DVC_QuyenLienQuan_SearchCongDan.SetPageSize($(e).val());
        Common.DVC_QuyenLienQuan_SearchCongDan.SubmitForm();
        return false;
    },
    ShowDialog: function () {
    ...
    LoadTableChuSoHuu: function () {
        var html = '';
        if (Common.DVC_QuyenLienQuan_SearchCongDan.ListChuSoHuu != null && Common.DVC_QuyenLienQuan_SearchCongDan.ListChuSoHuu.length > 0) {
            for (i = 0; i < Common.DVC_QuyenLienQuan_SearchCongDan.ListChuSoHuu.length; i++) {
                var chuSoHuu = Common.DVC_QuyenLienQuan_SearchCongDan.ListChuSoHuu[i];
                html += '<tr>';
                html += '<td class"cursor" onclick="Common.DVC_QuyenLienQuan_SearchCongDan.DetailCongDan(' + chuSoHuu.ChuSoHuuID + ')" data-label="Họ tên">' + chuSoHuu.HoVaTen + '</td>';
                ...
                html += '<button title="Xóa chủ sở hữu" data-id="' + chuSoHuu.ChuSoHuuID + '" class="btn btn-danger btn-sm" type="button" onclick="Common.DVC_QuyenLienQuan_SearchCongDan.RemovedChuSoHuu(' + i + ')"><i class="far fa-trash-alt"></i></button>';
                html += '</td>';
                html += '</tr>';
            }
        }
    ...
    LoadTableNguoiBieuDien: function () {
        var html = '';
        if (Common.DVC_QuyenLienQuan_SearchCongDan.ListNguoiBieuDien != null && Common.DVC_QuyenLienQuan_SearchCongDan.ListNguoiBieuDien.length > 0) {
            for (i = 0; i < Common.DVC_QuyenLienQuan_SearchCongDan.ListNguoiBieuDien.length; i++) {
                var nguoiBieuDien = Common.DVC_QuyenLienQuan_SearchCongDan.ListNguoiBieuDien[i];
                html += '<tr>';
                html += '<td class="cursor" onclick="Common.DVC_QuyenLienQuan_SearchCongDan.DetailCongDan(' + nguoiBieuDien.NguoiBieuDienID + ')" data-label="Họ tên">' + nguoiBieuDien.HoVaTen + '</td>';
                ...
                html += '<td data-label="Thao tác" class="text-center">';
                html += '<button title="Xóa tác giả" data-id="' + nguoiBieuDien.NguoiBieuDienID + '" class="btn btn-danger btn-sm" type="button" onclick="Common.DVC_QuyenLienQuan_SearchCongDan.RemovedNguoiBieuDien(' + i + ')"><i class="far fa-trash-alt"></i></button>';
                html += '</td>';
                html += '</tr>';
            }
        }
    ...
    RemovedChuSoHuu: function (id) {
        Common.DVC_QuyenLienQuan_SearchCongDan.ListChuSoHuu.splice(id, 1)
        Common.DVC_QuyenLienQuan_SearchCongDan.LoadTableChuSoHuu();
        return false;
    },
    RemovedNguoiBieuDien: function (id) {
        Common.DVC_QuyenLienQuan_SearchCongDan.ListNguoiBieuDien.splice(id, 1)
        Common.DVC_QuyenLienQuan_SearchCongDan.LoadTableNguoiBieuDien();
        return false;
    },
};

var DVC_QuyenLienQuan_SearchCongDan = DVC_QuyenLienQuan_SearchCongDan;
DVC_QuyenLienQuan_SearchCongDan.constructor = DVC_QuyenLienQuan_SearchCongDan;
