...
namespace CMS.Admin.Controllers
{
    ...
    public class RoxyFilemanController : BaseController
    {
        ...
        string confFile = "/admin/Library/Roxy_Fileman/conf.json";
        string subPath = "/admin";
        protected HttpContextBase _context;
        protected HttpResponseBase _r;
        #endregion
        ...
        protected virtual void CreateDir(string path, string name)
        {
            ...
            else
            {
                try
                {
                    //check
                    //mo ta ngan gon
                    if (!string.IsNullOrEmpty(name) && FileControl.GetNotWhitelistCreateFolder().Any(name.Contains))
                    {
        ...
        protected virtual void ListFiles(string path, string type)
        {
            ...
            for (int i = 0; i < files.Count; i++)
            {
                ...
                _r.Write("{");
                _r.Write("\"p\":\"" + subPath + path + "/" + f.Name + "\"");
